    ...
    <main className={styles.shell}>
      <aside className={styles.sidebar}>
        ...
        <div className={styles.upgrade}>
          ...
          <p>Premium tools, community, content and experiences in preparation.</p>
      ...
      <section className={styles.main}>
        ...
        <div className={styles.topGrid}>
          <article className={styles.aiHero} style={{backgroundImage:`url("${image}")`}}>
            ...
            <div className={styles.aiContent}>
              <span className={styles.online}>AI TRAINER X · PREVIEW</span>
              <h2>Your Personal<br/><em>AI Trainer</em></h2>
              <p>Training context, guidance and your MyTrainX ecosystem in one conversation. Full agent integration is in development.</p>
          ...
          <article className={styles.progress}>
            <div className={styles.panelTitle}><b>YOUR PROGRESS</b><small>Progress data integration pending</small></div>
            <div className={styles.metrics}>
              <div><span>◌</span><b>—</b><small>Day Streak</small></div>
              <div><span>▣</span><b>—</b><small>Workouts</small></div>
              <div><span className={styles.ring}>—</span><small>Readiness</small></div>
              <div><span>▥</span><b>—</b><small>Level</small></div>
            </div>
        ...
        <div className={styles.midGrid}>
          <article className={styles.today}>
            <div className={styles.panelTitle}><div><b>NEXT TRAINING</b><small>Available from your current program.</small></div><span>WKT · STARTER</span></div>
          ...
          <article className={styles.programs}>
            ...
            <div className={styles.programCards}>
              <Link href="/app/programas/wkt-militar" className={styles.programActive} style={{backgroundImage:`url("${image}")`}}><i>ACTIVE</i><b>WKT<br/><em>MILITAR</em></b><small>21 guided sessions</small></Link>
